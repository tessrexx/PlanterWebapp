          ...
          {userPlants.map((plant) => (
            <TableRow>
              ...
              <TableCell className="monthlyPlant">
                <img src={plant.jan} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.feb} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.mar} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.apr} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.may} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.jun} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.jul} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.aug} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.sep} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.oct} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.nov} alt="" />
              </TableCell>
              <TableCell className="monthlyPlant">
                <img src={plant.dec} alt="" />
              </TableCell>
              <TableCell className="harvestTime">{plant.harvest}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
